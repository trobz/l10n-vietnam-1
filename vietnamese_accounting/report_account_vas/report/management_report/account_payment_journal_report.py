...
class account_payment_journal_xls_parser(ARJR.account_receipt_journal_xls_parser):

    def __init__(self, cr, uid, name, context):
        super(account_payment_journal_xls_parser, self).__init__(cr, uid, name, context=context)
...
class account_payment_journal_xls(ARJR.account_receipt_journal_xls):
    ...
    def __init__(self, name, table, rml=False, parser=False, header=True, store=False):
        super(account_payment_journal_xls, self).__init__(name, table, rml, parser, header, store)

account_payment_journal_xls('report.account.payment.journal.report','account.move.line', parser=account_payment_journal_xls_parser)
